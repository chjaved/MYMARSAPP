...
function Container({ data }) {
  ...
  return (
    <div className="border-conversation-border border-l w-full bg-chat-background flex flex-col h-[100vh] overflow-hidden items-center justify-center text-black ">

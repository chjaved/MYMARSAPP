...
function ContactsList() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="h-full flex-auto overflow-auto " style={{ background: "linear-gradient(to right, , #0072ff,#ffffff)" }}>
        ...
        <div className="flex items-center gap-5 px-3 py-1 rounded-lg flex-grow" style={{ background: "linear-gradient(to right, , #0072ff,#ffffff)" }}>
            ...
            <div>
              <BiSearchAlt2 className="text-white cursor-pointer text-l" />
            </div>
            <div className="">
              <input
                type="text"
